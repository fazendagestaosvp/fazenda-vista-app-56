...
// Export the Animal interface to be used by components
...
export const useAnimalsWithAuth = () => {
  ...
  // Check if user can add (admins and editors)
...
// Export the useAnimals hook that is needed by Animais.tsx
export const useAnimals = () => {
  ...
  const { canEdit, canDelete, canAdd, toast } = useAnimalsWithAuth();
  ...
  const handleAddSuccess = (animal: Animal) => {
  ...
  const handleEditSuccess = (updatedAnimal: Animal) => {
