...
const AdminPromote = () => {
  ...
  const handlePromote = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Sucesso!",
        description: `O usuário ${email} foi promovido a administrador com sucesso!`,
      });
  ...
  return (
    <div className="max-w-md mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Promoção de Administrador</CardTitle>
          <CardDescription>
            Promova um usuário existente para o papel de administrador.
          </CardDescription>
        </CardHeader>
        <CardContent>
